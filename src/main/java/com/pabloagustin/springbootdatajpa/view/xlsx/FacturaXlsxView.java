package com.pabloagustin.springbootdatajpa.view.xlsx;
...
// No podemos tener dos componentes con el mismo nombre! cuidado! (@Component("factura/ver") como en PDF)
// Agregamos la extension. PDF queda como nombre default
...
public class FacturaXlsxView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		// Capturamos los parametros que nos esten enviando (Factura)
		Factura factura = (Factura) model.get("factura");

		// Para la traduccion
		MessageSourceAccessor mensajes = getMessageSourceAccessor();

		// Implementando nuestra planilla excel
		Sheet sheet = workbook.createSheet("Factura Spring");

		// Primera fila para los datos del cliente
		...
		// Diseno para el header y el body
		...
		int rownum = 10;
		// For para manejar los datos de la factura
		for(ItemFactura item: factura.getItems()){
			Row fila = sheet.createRow(rownum ++);
			// Creamos la celda por cada atributo
